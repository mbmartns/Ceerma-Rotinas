...
def process(bat, pasta_processados, tabela, relatorio, pasta_copia, estacoes_versoes, replace, arq_dat, caminho_tabela): #processa os dados
...
def end(bat, pasta_split, pasta_processados, tabela, relatorio, pasta_copia, estacoes_versoes, replace, arq_dat, caminho_tabela): #conferir se o processamento terminou
    while True:
        ...
        if terminar == 's':
            ...
            process(bat, pasta_processados, tabela, relatorio, pasta_copia, estacoes_versoes, replace, arq_dat, caminho_tabela)
            split(pasta_split)
...
split(pasta_split)
cria_kml(pasta_processados, tabela)
end(bat, pasta_split, pasta_processados, tabela, relatorio, pasta_copia, estacoes_versoes, replace, arq_dat, caminho_tabela)
